package com.uniovi.sdi.bookspace.util;
...
public class SeleniumUtils {
     ...
     *
     * @param driver: apuntando al navegador abierto actualmente.
     * @param criterion: "id" or "class" or "text" or "@attribute" or "free". Si el valor de criterio es free es una expresion xpath completa.
     ...
     */
    static public List<WebElement> waitLoadElementsBy(WebDriver driver, String criterion, String text, int timeout)
    {
